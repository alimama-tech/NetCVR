...
import math
class PretrainEsdfmRF_PLE_TimeCode(nn.Module):
    def __init__(self, args):
        ...
        self.film_scale = nn.Linear(2, 256) 
        self.film_shift = nn.Linear(2, 256)
    ...
    def cvr_forward(self,x,click_hour):
        ...
        click_hour_emb = self.encode_hour_to_sin_cos(click_hour.long())
        time_bias = self.cvr_time_net(click_hour_emb)
        ...
        cvr_logits = cvr_logits + time_bias
    ...
    def net_cvr_forward(self,x,click_hour):
        ...
        click_hour_emb = self.encode_hour_to_sin_cos(click_hour.long())
        time_bias = self.rfr_time_net(click_hour_emb)
        ...
        net_cvr_logits = net_cvr_logits + time_bias
