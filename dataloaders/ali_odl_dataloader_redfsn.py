...
from datasets.ali_odl_datasets_redfsn import get_ali_dataset_pretrain,get_ali_dataset_stream
...
def get_ali_stream_dataloader(args):
    ...
    main_train_stream = data_src['main_train_stream']
    feature_train_stream = data_src['feature_train_stream']
    unbias_train_stream = data_src['unbias_train_stream']
    test_stream = data_src['test_stream']

    main_train_stream_dataloader = AliOdlStreamLoader(main_train_stream, batch_size=args.batch_size, shuffle=False, num_workers=args.num_workers)
    feature_train_stream_dataloader = AliOdlStreamLoader(feature_train_stream, batch_size=args.batch_size, shuffle=False, num_workers=args.num_workers)
    unbias_train_stream_dataloader = AliOdlStreamLoader(unbias_train_stream, batch_size=args.batch_size, shuffle=False, num_workers=args.num_workers)
    ...
    return main_train_stream_dataloader,feature_train_stream_dataloader,unbias_train_stream_dataloader, test_stream_dataloader
