...
from datasets.ali_odl_datasets_esdfmRF import get_ali_dataset_pretrain,get_ali_dataset_stream
...
class AliPretrainOdlDatasets(Dataset):
    def __init__(self, data_dict):
        ...
        self.inw_refund_labels_afterRefund = torch.tensor(data_dict["inw_refund_labels_afterRefund"], dtype=torch.float32)
