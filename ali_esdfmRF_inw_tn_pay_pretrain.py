...
from trainers.ali_trainer_esdfmRF import AliPretrainInwTnPayEsdfmRFTrainer
...
def parse_args():
    ...
    parser.add_argument('--data_cache_path', type=str, default='/mnt/nfs/luomingxuan/airbench/exp_pw025/', help='Data path')
    ...
    parser.add_argument('--pay_wait_window', type=int, default=0.25, help='pay wait window size (days)')
    ...
    parser.add_argument('--mode', type=str, default="esdfmRF_inws_tn_pay_pretrain", help='[esdfmRF_inws_tn_pay_pretrain]')
    ...
    parser.add_argument('--model_save_pth', type=str, default='/mnt/nfs/luomingxuan/airbench/exp_pw025/', help='Model save pth')
...
if __name__ == '__main__':
    ...
    model = PretrainInwTnPayEsdfmRF(args).to(device)
    pretrain_trainer = AliPretrainInwTnPayEsdfmRFTrainer(args, model, train_loader, test_loader)
