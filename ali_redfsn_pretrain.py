...
from trainers.ali_trainer_redfsn import AliPretrainReDfsnTrainer
from dataloaders.ali_odl_dataloader_redfsn import get_ali_pretrain_dataloader
...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default="redfsn_pretrain", help='[redfsn_pretrain]')
    ...
    parser.add_argument('--pretrain_redfsn_model_pth', type=str, default='./pretrain_models/20250718/Ali_redfsn_pretrain.pth', help='if need a pretrain model to support')
...
if __name__ == '__main__':
    ...
    model = PretrainReDfsn(args).to(device)
    defer_pretrain_trainer = AliPretrainReDfsnTrainer(args, model, train_loader, test_loader)
