...
from trainers.ali_trainer_esdfmRF import AliPretrainEsdfmRF_ShareEmbTrainer
...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default="esdfmRF_ShareEmb_pretrain", help='[esdfmRF_ShareEmb_pretrain]')
...
if __name__ == '__main__':
    ...
    model = PretrainEsdfmRF_ShareEmb(args).to(device)
    pretrain_trainer = AliPretrainEsdfmRF_ShareEmbTrainer(args, model, train_loader, test_loader)
