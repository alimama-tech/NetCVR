...
from trainers.ali_trainer_ddfm import AliPretrainTnDpDdfmTrainer
...
def parse_args():
    ...
    parser.add_argument('--train_split_days_end', type=int, default=11, help='end day of train (days)')
    ...
    parser.add_argument('--mode', type=str, default="ddfm_tn_dp_pretrain", help='[ddfm_tn_dp_pretrain]')
    ...
    parser.add_argument('--pretrain_ddfm_model_pth', type=str, default='./pretrain_models/20250715/Criteo_defer_pretrain.pth', help='if need a pretrain model to support')
    parser.add_argument('--pretrain_ddfm_tn_dp_model_pth', type=str, default='./pretrain_models/20250715/aux_model_pth1/dp_model.pth', help='if need a pretrain dp model to support')
...
if __name__ == '__main__':
    ...
    model = PretrainTnDpDdfm(args).to(device)
    defer_pretrain_trainer = AliPretrainTnDpDdfmTrainer(args, model, train_loader, test_loader)
