...
from trainers.ali_trainer_defer import AliPretrainDpDeferTrainer
...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default="defer_dp_pretrain", help='[defer_pretrain,defer_dp_pretrain,defer_train_stream]')
...
if __name__ == '__main__':
    ...
    model = PretrainDpDefer(args).to(device)
    defer_pretrain_trainer = AliPretrainDpDeferTrainer(args, model, train_loader, test_loader)
