...
from trainers.ali_trainer_redefuse import AliPretrainReDefuseTrainer
...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default="redefuse_pretrain", help='[redefuse_pretrain]')
    ...
    parser.add_argument('--model_save_pth', type=str, default='./pretrain_models/20250718', help='Model save pth')
    parser.add_argument('--pretrain_redefuse_model_pth', type=str, default='./pretrain_models/20250718/Ali_refnc_pretrain.pth', help='if need a pretrain model to support')
...
if __name__ == '__main__':
    ...
    model = PretrainReDefuse(args).to(device)
    pretrain_trainer = AliPretrainReDefuseTrainer(args, model, train_loader, test_loader)
