...
from trainers.ali_trainer_esdfmRF import AliPretrainInwPayEsdfmRFTrainer
...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default="esdfmRF_inws_pay_pretrain", help='[esdfmRF_inws_pay_pretrain]')
...
if __name__ == '__main__':
    ...
    model = PretrainInwPayEsdfmRF(args).to(device)
    pretrain_trainer = AliPretrainInwPayEsdfmRFTrainer(args, model, train_loader, test_loader)
