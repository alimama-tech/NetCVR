...
from trainers.ali_trainer_esdfmRF import AliPretrainEsdfmRFTrainer
...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default="esdfmRF_pretrain", help='[esdfmRF_pretrain]')
...
if __name__ == '__main__':
    ...
    model = PretrainEsdfmRF(args).to(device)
    pretrain_trainer = AliPretrainEsdfmRFTrainer(args, model, train_loader, test_loader)
