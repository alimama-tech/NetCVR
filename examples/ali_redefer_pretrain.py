...
from trainers.ali_trainer_redefer import AliPretrainReDeferTrainer
...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default="redefer_pretrain", help='[redefer_pretrain]')
    ...
    parser.add_argument('--model_save_pth', type=str, default='./pretrain_models/20250809', help='Model save pth')
    parser.add_argument('--pretrain_redefer_model_pth', type=str, default='./pretrain_models/20250808/Criteo_defer_pretrain.pth', help='if need a pretrain model to support')
...
if __name__ == '__main__':
    ...
    model = PretrainReDefer(args).to(device)
    pretrain_trainer = AliPretrainReDeferTrainer(args, model, train_loader, test_loader)
