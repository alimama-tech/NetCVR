...
from trainers.ali_trainer_remiss import AliPretrainReMissTrainer
from dataloaders.ali_odl_dataloader_remiss import get_ali_pretrain_dataloader
...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default="remiss_pretrain", help='[remiss_pretrain]')
    ...
    parser.add_argument('--pretrain_miss_model_pth', type=str, default='./pretrain_models/20250718/Ali_refnc_pretrain.pth', help='if need a pretrain model to support')
...
if __name__ == '__main__':
    ...
    model = PretrainReMiss(args).to(device)
    pretrain_trainer = AliPretrainReMissTrainer(args, model, train_loader, test_loader)
