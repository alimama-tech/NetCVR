...
from trainers.ali_trainer_refnc import AliPretrainReFncTrainer
...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default="refnc_pretrain", help='[refnc_pretrain]')
...
if __name__ == '__main__':
    ...
    model = PretrainReFnc(args).to(device)
    pretrain_trainer = AliPretrainReFncTrainer(args, model, train_loader, test_loader)
