...
from trainers.ali_trainer_reoracle import AliPretrainReOracleTrainer
...
def parse_args():
    ...
    parser.add_argument('--train_split_days_end', type=int, default=14, help='end day of train (days)')
    ...
    parser.add_argument('--mode', type=str, default="reoracle_pretrain", help='[reoracle_pretrain]')
    ...
    parser.add_argument('--pretrain_reoracle_model_pth', type=str, default='/mnt/nfs/luomingxuan/airbench/main_exp/Ali_reoracle_pretrain.pth', help='if need a pretrain model to support')
...
if __name__ == '__main__':
    ...
    model = PretrainReOracle(args).to(device)
    pretrain_trainer = AliPretrainReOracleTrainer(args, model, train_loader, test_loader)
