...
from trainers.ali_trainer_base import AliPretrainBaseTrainer
...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default="base_pretrain", help='[base_pretrain]')
...
if __name__ == '__main__':
    ...
    model = PretrainBase(args).to(device)
    pretrain_trainer = AliPretrainBaseTrainer(args, model, train_loader, test_loader)
