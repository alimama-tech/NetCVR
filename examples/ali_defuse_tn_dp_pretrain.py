...
from trainers.ali_trainer_defuse import AliPretrainTnDpDefuseTrainer
...
def parse_args():
    ...
    parser.add_argument('--data_cache_path', type=str, default='/mnt/nfs/luomingxuan/airbench/abl_exp1_1d/', help='Data path')
    ...
    parser.add_argument('--mode', type=str, default="defuse_tn_dp_pretrain", help='[defuse_tn_dp_pretrain]')
    ...
    parser.add_argument('--model_save_pth', type=str, default='/mnt/nfs/luomingxuan/airbench/abl_exp1_1d/', help='Model save pth')
...
if __name__ == '__main__':
    ...
    model = PretrainTnDpDefuse(args).to(device)
    defer_pretrain_trainer = AliPretrainTnDpDefuseTrainer(args, model, train_loader, test_loader)
