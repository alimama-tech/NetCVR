...
from trainers.ali_trainer_reddfm import AliPretrainReDdfmTrainer
...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default="reddfm_pretrain", help='[reddfm_pretrain]')
    ...
    parser.add_argument('--pretrain_reddfm_model_pth', type=str, default='./pretrain_models/20250718/Ali_refnc_pretrain.pth', help='if need a pretrain model to support')
...
if __name__ == '__main__':
    ...
    model = PretrainReDdfm(args).to(device)
    pretrain_trainer = AliPretrainReDdfmTrainer(args, model, train_loader, test_loader)
