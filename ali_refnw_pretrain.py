...
from trainers.ali_trainer_refnw import AliPretrainReFnwTrainer
from dataloaders.ali_odl_dataloader import get_ali_pretrain_dataloader
from models.ali_pretrain_refnw import PretrainReFnw
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default="refnw_pretrain", help='[refnw_pretrain]')
    ...
    parser.add_argument('--pretrain_refnw_model_pth', type=str, default='./pretrain_models/20250718/Ali_refnw_pretrain.pth', help='if need a pretrain model to support')
...
if __name__ == '__main__':
    ...
    model = PretrainReFnw(args).to(device)
    pretrain_trainer = AliPretrainReFnwTrainer(args, model, train_loader, test_loader)
