...
from trainers.ali_trainer_esdfmRF import AliPretrainInwTnRefundEsdfmRFTrainer
...
def parse_args():
    ...
    parser.add_argument('--data_cache_path', type=str, default='/mnt/nfs/luomingxuan/airbench/exp_rw0003/', help='Data path')
    ...
    parser.add_argument('--refund_wait_window', type=int, default=0.003, help='refund wait window size (days)')
    ...
    parser.add_argument('--mode', type=str, default="esdfmRF_inws_tn_refund_pretrain", help='[esdfmRF_inws_tn_refund_pretrain]')
    ...
    parser.add_argument('--model_save_pth', type=str, default='/mnt/nfs/luomingxuan/airbench/exp_rw0003/', help='Model save pth')
...
if __name__ == '__main__':
    ...
    model = PretrainInwTnRefundEsdfmRF(args).to(device)
    pretrain_trainer = AliPretrainInwTnRefundEsdfmRFTrainer(args, model, train_loader, test_loader)
