...
from trainers.ali_trainer_reesdfm import AliPretrainReEsdfmTrainer
...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, default="reesdfm_pretrain", help='[reesdfm_pretrain]')
    ...
    parser.add_argument('--pretrain_reesdfm_model_pth', type=str, default='./pretrain_models/20250718/Ali_refnc_pretrain.pth', help='if need a pretrain model to support')
...
if __name__ == '__main__':
    ...
    model = PretrainReEsdfm(args).to(device)
    pretrain_trainer = AliPretrainReEsdfmTrainer(args, model, train_loader, test_loader)
